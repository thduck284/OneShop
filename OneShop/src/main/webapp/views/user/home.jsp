...
<body>
	<div style="width: 1387px; margin-left: -45px;">
		...
		<div class="btn-group" style="margin-bottom: 20px;">
			...
			<a href="?filter=top-rated&page=1&pageSize=5" class="btn btn-info ${filter == 'top-rated' ? 'active' : ''}">Đánh giá cao</a>
			<a href="?filter=favorite&page=1&pageSize=5" class="btn btn-warning ${filter == 'favorite' ? 'active' : ''}">Yêu thích</a>
			<a href="?filter=all" class="btn btn-secondary ${filter == 'all' ? 'active' : ''}">Xem tất cả</a>
		</div>
		<div class="row">
