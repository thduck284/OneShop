						...
						<div class="card card-transparent">
							<div class="card-header card-header-transparent py-20">
								<div class="btn-group dropdown">
									<h4 style="margin-top: -50px;">Home -> Cửa hàng</h4>
								</div>
							</div>
						</div>
					</div>
						...
						<div id="recent-transactions" class="col-12">
							...
							<div style="margin: -60px 0 20px 970px;">
								<div class="btn-group me-2"> 
    								<a href="http://localhost:8080/OneShop/admin/shop" class="btn btn-success btn-sm" 
        								style="font-size: 15px; padding: 8px 16px;">Xem chi tiết</a>
								</div>
								<div class="btn-group me-2">
									<a class="btn btn-primary btn-sm"
										href="http://localhost:8080/OneShop/admin/add-shop"
										style="font-size: 15px; padding: 8px 16px;">Thêm</a>
								</div>
								<div class="btn-group">
									<a href="http://localhost:8080/OneShop/admin/shop" class="btn btn-warning btn-sm" 
											...
											<table id="recent-orders"
												...
												<tbody>
													<c:forEach var="shop" items="${shops}">
														<tr>
															<td><a class="border-top-1">${shop.shopId}</a></td>
															<td><a>${shop.userId}</a></td>
															<td><a>${shop.userName}</a></td>
															<td><a>${shop.totalPrice}</a></td>
															<td>${shop.formattedCreatedDate}</td>
															<td class="d-flex flex-column gap-0">
																<a href="${pageContext.request.contextPath}/admin/edit-shop?shopId=${shop.shopId}"
																	class="btn btn-warning btn-sm"
																	style="margin: 0 0 15px 0;">Sửa</a>
																<form action="${pageContext.request.contextPath}/admin/delete-shop" 
