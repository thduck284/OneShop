									...
									<div class="table-responsive">
										<div class="table-wrapper">
											<table id="recent-orders"
												...
												<thead>
													<tr>
														<th class="border-top-0" style="width: 20%;">Mã giỏ hàng</th>
														<th class="border-top-0" style="width: 20%;">Mã sản phẩm</th>
														<th class="border-top-0" style="width: 30%;">Tên sản phẩm</th>
														<th class="border-top-0" style="width: 20%;">Số lượng</th>
														<th class="border-top-0" style="width: 20%;">Giá</th>
												...
												<tbody>
													<c:forEach var="dCart" items="${cartDetail}">
														<tr>
															<td><a class="border-top-1">${dCart.cartId}</a></td>
															<td><a>${dCart.productId}</a></td>
															<td><a>${dCart.productName}</a></td>
															<td><a>${dCart.quantity}</a></td>
															<td>${dCart.price}</td>
															<td class="d-flex flex-column gap-0">
																<a href="${pageContext.request.contextPath}/admin/edit-cart-detail?cartId=${dCart.cartId}&productId=${dCart.productId}"
