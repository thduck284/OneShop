...
<link rel="stylesheet" type="text/css" href="../static/styles/admin/app-assets/vendors/css/charts/chartist-plugin-tooltip.css">
...
<link rel="stylesheet" type="text/css" href="../static/styles/admin/app-assets/css/pages/dashboard-ico.css">
...
<body>
    ...
    <script src="../static/styles/admin/app-assets/vendors/js/charts/chartist.min.js" type="text/javascript"></script>
