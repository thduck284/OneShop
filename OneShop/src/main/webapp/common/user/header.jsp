...
<body>
	...
	<div class="header">
		...
		<div class="dropdown">
			<%
  					User loggedInUser = (User) session.getAttribute("userInfor");
			%>
			<a class="login" href="<%= (loggedInUser == null) ? request.getContextPath() + "/login" : "#" %>">
				<%
			...
			<div class="dropdown-content">
				<a class="login-content" href="#">Tài khoản của tôi</a> 
				<a class="login-content" href="<%=request.getContextPath()%>/logout">Đăng xuất</a>
			</div>
			<% } else { %>
			<% } %>
		</div>
	...
	<div class="under-header">
		<a class="home-page" href="http://localhost:8080/OneShop/comestics.com">Trang chủ</a>
